    ...
    public partial class CompleteDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Histiories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Histiories_Pets_PetId",
                        column: x => x.PetId,
                        principalTable: "Pets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Histiories_ServiceTypes_ServiceTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Histiories_PetId",
                table: "Histiories",
                column: "PetId");

            migrationBuilder.CreateIndex(
                name: "IX_Histiories_ServiceTypeId",
                table: "Histiories",
